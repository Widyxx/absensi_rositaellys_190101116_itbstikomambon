        ...
        <div class="card">
            <form action="<?= base_url('user/update_foto') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-success btn-block mt-2">Simpan <i class="fa fa-save"></i></button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="card-footer">
                    <div class="row w-100">
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <button type="submit" class="btn btn-success btn-block">Simpan <i class="fa fa-save"></i></button>
                        </div>
                    </div>
                </div>
            </form>
