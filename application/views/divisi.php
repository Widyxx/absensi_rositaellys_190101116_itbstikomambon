    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title float-left">Kategori Guru</h4>
                <div class="d-inline ml-auto float-right">
                    <a href="#" class="btn btn-success btn-sm btn-add-divisi" data-toggle="modal" data-target="#modal-add-divisi"><i class="fa fa-plus"></i> Kategori Guru</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody id="tbody-divisi">
                            <?php foreach($divisi as $i => $d): ?>
                                <tr id="<?= 'divisi-' . $d->id_divisi ?>">
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success btn-sm btn-edit-divisi" data-toggle="modal" data-target="#modal-edit-divisi" data-divisi="<?= base64_encode(json_encode($d)) ?>"><i class="fa fa-edit"></i> Edit</a> 
        ...
        <div class="modal-content">
            <form id="form-add-divisi" action="<?= base_url('divisi/store') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-add-divisi-label">Tambah Jabatan</h5>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="form-edit-divisi" action="<?= base_url('divisi/update') ?>" method="post" onsubmit="return false">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-edit-divisi-label">Edit Jabatan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
